...
public class GuanYinPotraitControl : MonoBehaviour {
    ...
    public void PushStory()
    {
        ...
        if (i == 1)
        {
            NowGyp = DataGlobal.GetSubsection(121);
            Sprite TempSP = new Sprite();
            TempSP = Resources.Load<Sprite>("GuanYinPotraitSprite/" + NowGyp.backGround.ToString()) as Sprite;
            if (TempSP != null)
            {
            ...
            TempPO = Resources.Load<Sprite>("AVGIdol/" + NowGyp.idol.ToString()) as Sprite;
            if (TempPO != null)
            {
                idol.sprite = TempPO;
            }          
        ...
        if (i == 2)
        {
            NowGyp = DataGlobal.GetSubsection(122);         
        }
        if (i == 3)
        {
            NowGyp = DataGlobal.GetSubsection(123);       
        }
        if (i > 0 && i < 4)
        {
            dialog.text = NowGyp.dialogCN;
            backGroundVoice.clip = Resources.Load<AudioClip>("GuanYinAudioClip/" + NowGyp.audio);
        }
    }

...
public class DragonControl : MonoBehaviour
{
    ...
    public void PushStory()
    {
        ...
        if (i == 1)
        {
            NowDr = DataGlobal.GetSubsection(41);          
        }
        if (i == 2)
        {
            NowDr = DataGlobal.GetSubsection(42);         
        }
        if (i > 0 && i < 3)
        {
            dialog.text = NowDr.dialogCN;
            backGroundVoice.clip = Resources.Load<AudioClip>("DragonAudioClip/" + NowDr.audio);
        }
    }
    public void SpriteChange()
    {
        ...
        TempSP = Resources.Load<Sprite>("DragonSprite/" + NowDr.backGround.ToString()) as Sprite;
        if (TempSP != null)
        {
        ...
        TempPO = Resources.Load<Sprite>("AVGIdol/" + NowDr.idol.ToString()) as Sprite;
        if (TempPO != null)
        {
            idol.sprite = TempPO;
        }
